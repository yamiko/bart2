...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`%`@`%`*/ /*!50003 FUNCTION `age`(birthdate varchar(10),visit_date varchar(10),date_created varchar(10),est int) RETURNS int(11)
    DETERMINISTIC
BEGIN
DECLARE n INT;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`%`@`%`*/ /*!50003 FUNCTION `age_group`(birthdate varchar(10),visit_date varchar(10),date_created varchar(10),est int) RETURNS varchar(25) CHARSET latin1
    DETERMINISTIC
BEGIN
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`%`@`%`*/ /*!50003 FUNCTION `current_defaulter`(my_patient_id INT, my_end_date DATE) RETURNS int(1)
BEGIN
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`%`@`%`*/ /*!50003 FUNCTION `current_state_for_program`(my_patient_id INT, my_program_id INT, my_end_date DATE) RETURNS int(11)
BEGIN
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`%`@`%`*/ /*!50003 FUNCTION `current_value_for_obs`(my_patient_id INT, my_encounter_type_id INT, my_concept_id INT, my_end_date DATE) RETURNS int(11)
BEGIN
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`%`@`%`*/ /*!50003 FUNCTION `patient_start_date`(patient_id int) RETURNS varchar(10) CHARSET latin1
    DETERMINISTIC
BEGIN
