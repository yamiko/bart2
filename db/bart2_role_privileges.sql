...
INSERT INTO `role_privilege` VALUES ('Pharmacist','Manage appointments'),('Pharmacist','Manage ART adherence'),('Pharmacist','Manage ART visits'),('Pharmacist','Manage drug dispensations'),('Pharmacist','Manage HIV first visits'),('Pharmacist','Manage HIV reception visits'),('Pharmacist','Manage HIV staging visits'),('Pharmacist','Manage Patient Programs'),('Pharmacist','Manage pre ART visits'),('Pharmacist','Manage prescriptions'),('Pharmacist','Manage Relationships'),('Pharmacist','Manage TB Reception Visits'),('Pharmacist','Manage Vitals'),('Pharmacist','Manage HIV Status Visits'),('Pharmacist','Manage TB Clinic Visits'), ('Pharmacist','Manage TB Registration Visits'), ('Pharmacist','Manage Lab Orders'), ('Pharmacist','Manage Sputum Submissions'), ('Pharmacist','Manage Lab Results'), ('Pharmacist','Manage TB Treatment Visits'), ('System Developer','Manage TB adherence'), ('System Developer','Manage TB initial visits');
