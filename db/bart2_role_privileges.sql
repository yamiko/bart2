...
INSERT INTO `role_privilege` VALUES ('General Registration Clerk','Manage appointments'),('General Registration Clerk','Manage ART adherence'),('General Registration Clerk','Manage ART visits'),('General Registration Clerk','Manage drug dispensations'),('General Registration Clerk','Manage HIV first visits'),('General Registration Clerk','Manage HIV reception visits'),('General Registration Clerk','Manage HIV staging visits'),('General Registration Clerk','Manage Patient Programs'),('General Registration Clerk','Manage pre ART visits'),('General Registration Clerk','Manage prescriptions'),('General Registration Clerk','Manage Relationships'),('General Registration Clerk','Manage TB Reception Visits'),('General Registration Clerk','Manage Vitals'),('General Registration Clerk','Manage HIV Status Visits'),('General Registration Clerk','Manage TB Clinic Visits'), ('General Registration Clerk','Manage TB Registration Visits'), ('General Registration Clerk','Manage Lab Orders'), ('General Registration Clerk','Manage Sputum Submissions'), ('General Registration Clerk','Manage Lab Results');

INSERT INTO `role_privilege` VALUES ('Data Assistant','Manage appointments'),('Data Assistant','Manage ART adherence'),('Data Assistant','Manage ART visits'),('Data Assistant','Manage drug dispensations'),('Data Assistant','Manage HIV first visits'),('Data Assistant','Manage HIV reception visits'),('Data Assistant','Manage HIV staging visits'),('Data Assistant','Manage Patient Programs'),('Data Assistant','Manage pre ART visits'),('Data Assistant','Manage prescriptions'),('Data Assistant','Manage Relationships'),('Data Assistant','Manage TB Reception Visits'),('Data Assistant','Manage Vitals'),('Data Assistant','Manage HIV Status Visits'),('Data Assistant','Manage TB Clinic Visits'), ('Data Assistant','Manage TB Registration Visits'), ('Data Assistant','Manage Lab Orders'), ('Data Assistant','Manage Sputum Submissions'), ('Data Assistant','Manage Lab Results');
