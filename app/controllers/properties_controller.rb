class PropertiesController < ApplicationController
  def set_clinic_holidays
    @clinic_holidays = get_global_property_value('clinic.holidays') rescue nil
    render :layout => "menu"
  end
  ...
  def clinic_holidays
    @holidays = get_global_property_value('clinic.holidays') rescue []
  ...
  def clinic_days
    ...
    @peads_clinic_days = get_global_property_value('peads.clinic.days') rescue nil
    @clinic_days = get_global_property_value('clinic.days') rescue nil
    render :layout => "menu"
  end
  ...
  def week_days(property)
    wkdays = {}
    days = get_global_property_value(property) rescue ''
